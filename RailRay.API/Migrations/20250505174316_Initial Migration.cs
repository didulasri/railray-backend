    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Scedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Scedules_Stations_FromStationId",
                        column: x => x.FromStationId,
                        principalTable: "Stations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Scedules_Stations_ToStationId",
                        column: x => x.ToStationId,
                        principalTable: "Stations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Scedules_Trains_TrainId",
                        column: x => x.TrainId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainScheduleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Bookings_Scedules_TrainScheduleId",
                        column: x => x.TrainScheduleId,
                        principalTable: "Scedules",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scedules_FromStationId",
                table: "Scedules",
                column: "FromStationId");

            migrationBuilder.CreateIndex(
                name: "IX_Scedules_ToStationId",
                table: "Scedules",
                column: "ToStationId");

            migrationBuilder.CreateIndex(
                name: "IX_Scedules_TrainId",
                table: "Scedules",
                column: "TrainId");
